...
map("n", "z3", function() CloseLevel(3) end)
map("n", "z4", function() CloseLevel(4) end)
map("n", "z5", function() CloseLevel(5) end)
map("n", "z6", function() CloseLevel(6) end)
map("n", "z7", function() CloseLevel(7) end)
