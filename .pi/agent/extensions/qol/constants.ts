export const INSTALL_SYMBOL = Symbol.for("pi-qol.installed");
...
export const THINKING_TIMER_STORE_SYMBOL = Symbol.for("pi-qol.thinking-timer.store");
export const THINKING_TIMER_PATCH_SYMBOL = Symbol.for("pi-qol.thinking-timer.patch");
