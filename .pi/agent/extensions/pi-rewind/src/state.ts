...
export interface RewindState {
  ...
  /** Absolute path to shadow .git dir (bare repo) for non-git tracked dirs */
  shadowRepoDir: string | null;
  /** Absolute path to work tree (the tracked dir) for shadow repos */
  shadowWorkTree: string | null;
}
...
export function resetState(state: RewindState): void {
  ...
  state.shadowRepoDir = null;
  state.shadowWorkTree = null;
}
