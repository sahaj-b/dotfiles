...
| `recorder`                                | Wrapper for `wl-screenrec` with notifs and waybar module                                         |
...
| `pwr <0/1/2/3>`                           | Power mode controller: RAPL, governor, EPP, GPU, ASPM, WiFi, BT, sound PM                        |
| `arc`                                     | remove/rescan Intel ARC dgpu to save power                                                       |
